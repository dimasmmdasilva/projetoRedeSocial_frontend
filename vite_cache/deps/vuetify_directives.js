...
import { consoleError, isObject } from './chunk-F5DVVDZT.js'
import { h, mergeProps, render, resolveComponent } from './chunk-IJV5NOMV.js'
    ...
    const { handler, options } =
        typeof value === 'object'
            ...
            : {
                  ...
                  options: {
                      attributes:
                          (modifierKeys == null ? void 0 : modifierKeys.attr) ??
                          defaultValue,
                      characterData:
                          (modifierKeys == null ? void 0 : modifierKeys.char) ??
                          defaultValue,
                      childList:
                          (modifierKeys == null
                              ? void 0
                              : modifierKeys.child) ?? defaultValue,
                      subtree:
                          (modifierKeys == null ? void 0 : modifierKeys.sub) ??
                          defaultValue,
                  },
              }
...
function mountComponent(component, props) {
    return function (el, binding, vnode) {
        ...
        const text =
            ((_a = binding.value) == null ? void 0 : _a.text) ??
            binding.value ??
            (_props == null ? void 0 : _props.text)
        const value = isObject(binding.value) ? binding.value : {}
        const children = () => text ?? el.textContent
        const provides =
            (vnode.ctx === binding.instance.$
                ? (_b = findComponentParent(vnode, binding.instance.$)) == null
                    ? void 0
                    : _b.provides
                : (_c = vnode.ctx) == null
                  ? void 0
                  : _c.provides) ?? binding.instance.$.provides
...
function findComponentParent(vnode, root) {
    ...
    const walk = (children) => {
        ...
        for (const child of children) {
            ...
            if (
                child === vnode ||
                (child.el && vnode.el && child.el === vnode.el)
            ) {
                return true
            }
            stack.add(child)
            ...
            if (child.suspense) {
                ...
                result2 = walk([
                    (_b = child.component) == null ? void 0 : _b.subTree,
                ])
            }
            if (result2) {
                return result2
