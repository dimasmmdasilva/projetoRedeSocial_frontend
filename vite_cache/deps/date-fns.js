...
import { __publicField } from './chunk-UVKRO5ER.js'
...
function differenceInCalendarISOWeekYears(laterDate, earlierDate, options) {
    ...
    return (
        getISOWeekYear(laterDate_, options) -
        getISOWeekYear(earlierDate_, options)
    )
}
...
function differenceInCalendarWeeks(laterDate, earlierDate, options) {
    ...
    const earlierTimestamp =
        +earlierStartOfWeek -
        getTimezoneOffsetInMilliseconds(earlierStartOfWeek)
...
function differenceInMonths(laterDate, earlierDate, options) {
    ...
    let isLastMonthNotFull =
        compareAsc(workingLaterDate, earlierDate_) === -sign
    if (
...
function endOfWeek(date, options) {
    ...
    const weekStartsOn =
        ...
        ((_d = (_c = defaultOptions.locale) == null ? void 0 : _c.options) ==
        null
            ? void 0
            : _d.weekStartsOn) ??
        0
...
function format(date, formatStr, options) {
    ...
    const weekStartsOn =
        ...
        ((_f =
            ...
            : _f.weekStartsOn) ??
        defaultOptions.weekStartsOn ??
        ((_h = (_g = defaultOptions.locale) == null ? void 0 : _g.options) ==
        null
            ? void 0
            : _h.weekStartsOn) ??
        0
