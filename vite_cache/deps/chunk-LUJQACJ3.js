...
function startOfWeek(date, options) {
    ...
    const weekStartsOn =
        ...
        ((_d = (_c = defaultOptions2.locale) == null ? void 0 : _c.options) ==
        null
            ? void 0
            : _d.weekStartsOn) ??
        0
...
function isSameWeek(laterDate, earlierDate, options) {
    ...
    return (
        +startOfWeek(laterDate_, options) ===
        +startOfWeek(earlierDate_, options)
    )
}
...
//# sourceMappingURL=chunk-LUJQACJ3.js.map
