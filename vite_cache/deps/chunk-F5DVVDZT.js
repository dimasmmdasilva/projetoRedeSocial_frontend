...
function findChildrenWithProvide(key, vnode) {
    ...
    if (Array.isArray(vnode)) {
        ...
        if (
            Object.getOwnPropertySymbols(vnode.component.provides).includes(key)
        ) {
...
function getNextElement(elements, location, condition) {
    ...
    do {
        ...
        (!_el ||
            _el.offsetParent == null ||
            !((condition == null ? void 0 : condition(_el)) ?? true)) &&
        idx < elements.length &&
        idx >= 0
    )
    return _el
...
function getCurrentInstanceName() {
    ...
    return toKebabCase(
        (vm == null ? void 0 : vm.aliasName) || (vm == null ? void 0 : vm.name)
    )
}
var _uid = 0
...
function propIsDefined(vnode, prop) {
    var _a, _b
    return (
        typeof ((_a = vnode.props) == null ? void 0 : _a[prop]) !==
            'undefined' ||
    ...
    const _props = new Proxy(props, {
        get(target, prop) {
            ...
            if (prop === 'class' || prop === 'style') {
                ...
                typeof prop === 'string' &&
                !propIsDefined(vm.vnode, prop)
            ) {
                return ((_b = componentDefaults.value) == null
                    ? void 0
                    : _b[prop]) !== void 0
                    ? (_c = componentDefaults.value) == null
                        ? void 0
                        : _c[prop]
                    : ((_e =
                            (_d = defaults.value) == null
                                ? void 0
                                : _d.global) == null
                            ? void 0
                            : _e[prop]) !== void 0
                      ? (_g =
                            (_f = defaults.value) == null
                                ? void 0
                                : _f.global) == null
                          ? void 0
                          : _g[prop]
...
function genericComponent() {
    ...
    return (options) =>
        (exposeDefaults ? defineComponent2 : defineComponent)(options)
}
    ...
    Object.keys(props).forEach((k) => {
        ...
        if (isOn(k)) {
            ...
            if (props[k] == null) {
                ...
                !((_a = [...handler]) == null
                    ? void 0
                    : _a.some((v) => v[0] === name && v[1] === props[k]))
            ) {
...
var cielabForwardTransform = (t) =>
    t > delta ** 3 ? Math.cbrt(t) : t / (3 * delta ** 2) + 4 / 29
var cielabReverseTransform = (t) =>
...
var srgbForwardTransform = (C) =>
    C <= 31308e-7 ? C * 12.92 : 1.055 * C ** (1 / 2.4) - 0.055
var srgbReverseMatrix = [
    [0.4124, 0.3576, 0.1805],
    [0.2126, 0.7152, 0.0722],
    [0.0193, 0.1192, 0.9505],
]
var srgbReverseTransform = (C) =>
...
function useProxiedModel(props, prop, defaultValue) {
    ...
    const isControlled = checkKebab
        ? computed(() => {
              ...
              void props[prop]
              return !!(
                  (((_a = vm.vnode.props) == null
                      ? void 0
                      : _a.hasOwnProperty(prop)) ||
                      ((_b = vm.vnode.props) == null
                          ? void 0
                          : _b.hasOwnProperty(kebabProp))) &&
                  (((_c = vm.vnode.props) == null
                      ? void 0
                      : _c.hasOwnProperty(`onUpdate:${prop}`)) ||
                      ((_d = vm.vnode.props) == null
                          ? void 0
                          : _d.hasOwnProperty(`onUpdate:${kebabProp}`)))
              )
          })
        : computed(() => {
              var _a, _b
              ...
              return !!(
                  ...
                  ((_b = vm.vnode.props) == null
                      ? void 0
                      : _b.hasOwnProperty(`onUpdate:${prop}`))
              )
          })
    useToggleScope(
        () => !isControlled.value,
    ...
    const model = computed({
        get() {
            ...
            return transformIn(
                isControlled.value ? externalValue : internal.value
            )
        },
        set(internalValue) {
            const newValue = transformOut(internalValue)
            const value = toRaw(
                isControlled.value ? props[prop] : internal.value
            )
...
function createVuetifyAdapter(options) {
    const current = shallowRef(
        (options == null ? void 0 : options.locale) ?? 'en'
    )
    const fallback = shallowRef(
        (options == null ? void 0 : options.fallback) ?? 'en'
    )
    const messages = ref({
        en: en_default,
...
function createLocale(options) {
    const i18n =
        (options == null ? void 0 : options.adapter) &&
        isLocaleInstance(options == null ? void 0 : options.adapter)
            ? options == null
                ? void 0
                : options.adapter
...
function createRtl(i18n, options) {
    ...
    return {
        ...
        rtl,
        rtlClasses: computed(
            () => `v-locale--is-${isRtl.value ? 'rtl' : 'ltr'}`
        ),
    }
}
...
function parseThemeOptions() {
    ...
    for (const [key, theme] of Object.entries(options.themes ?? {})) {
        const defaultTheme =
            theme.dark || key === 'dark'
                ? (_a = defaults.themes) == null
                    ? void 0
                    : _a.dark
                : (_b = defaults.themes) == null
                  ? void 0
                  : _b.light
...
function createTheme(options) {
                ...
                for (const name3 of parsedOptions.variations.colors) {
                    ...
                    for (const variation of ['lighten', 'darken']) {
                        ...
                        for (const amount of createRange(
                            ...
                            theme.colors[`${name3}-${variation}-${amount}`] =
                                RGBtoHex(fn(parseColor(color), amount))
                        }
                    }
                }
            }
    ...
    const themeClasses = computed(() =>
        parsedOptions.isDisabled ? void 0 : `v-theme--${name.value}`
    )
    return {
        install,
...
function provideTheme(props) {
    ...
    const themeClasses = computed(() =>
        theme.isDisabled ? void 0 : `v-theme--${name.value}`
    )
    const newTheme = {
        ...theme,
        name,
...
//# sourceMappingURL=chunk-F5DVVDZT.js.map
